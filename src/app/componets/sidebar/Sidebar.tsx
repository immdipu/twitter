...
const Sidebar = () => {
  ...
  return (
    <div className="">
      ...
      <aside
        id="default-sidebar"
        className="fixed  top-0 border-r border-gray-400 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <section className="absolute items-center bg-neutral-200 bottom-0 left-0 right-0 px-5 gap-3 py-8 flex">
            {auth.profilePic && (
